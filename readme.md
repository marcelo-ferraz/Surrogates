...
- [Welcome to Surrogates](#user-content-welcome-to-surrogates)
- [Mapping](#user-content-Mapping)
	- [Expressions](#user-content-Expressions)
	- [Surrogates Command Language (SCL)](#user-content-)
- [Intercepting](#user-content-intercepting)
	- [ Replacing](#user-content-replacing)
	- [Visiting](#user-content-visiting)
	- [ Disabling](#user-content-disabling)
- [Rules](#user-content-rules)
	- [Rules for Methods and Properties](#user-content-rules-for-methods-and-properties)
	- [Rules for Parameters](#user-content-rules-for-parameters)
- [Special Parameters](#user-content-special-parameters)
	- [Special Parameters for Properties](#user-content-)
	- [Special Parameters for methods](#user-content-)
	- [The special s_method parameter](#user-content-)
		- [How to name it](#user-content-)
		- [How to type it](#user-content-)
		- [How to use it](#user-content-)
- [ Usages](#user-content-)
	- [Creating a pool aspect](#user-content-)
	- [Depency Injection](#user-content-)
	- [Disabling a method](#user-content-)
	- [Adding instrumentation](#user-content-)
	- [Adding Lazy loading Aspect](#user-content-)
	- [Adding logs](#user-content-)
	- [Intercepting specific methods](#user-content-)
	- [Multi-dispatch delegate behaviour](#user-content-)
