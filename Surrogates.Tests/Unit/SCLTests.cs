...
{
    public class SCLTests : UnitTests
    {
        ...
        private Strategies GetStrategies(string cmd, Type baseType, Type[] interceptors, string[] aliases)
        {
            try
            {
                return (Strategies)_parseStrCmdMethod.Invoke(
